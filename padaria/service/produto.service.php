<?php
    ...
    function listarProduto($filtroNome) {
        ...
        foreach($produtos as $produto) {
            ...
            echo "<td><form action='executa_acao_produto.php' method='post' class='remover'><input type='hidden' name='acao' value='remover'><input type='hidden' name='id' value='".$produto->id."'><button type='submit'>Remover</button></form></td>";
            echo "</tr>";
        }
        echo "</tbody></table>";
